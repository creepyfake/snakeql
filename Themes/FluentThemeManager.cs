...
{
    private static readonly Uri BaseUri = new("avares://snakeql/Styles");
    ...
    {
        new StyleInclude(BaseUri) { Source = new Uri("avares://snakeql/Themes/FluentDark.axaml") },
    };

    private static readonly Styles FluentLight = new()
    {
        new StyleInclude(BaseUri) { Source = new Uri("avares://snakeql/Themes/FluentLight.axaml") },
    };
