...
using snakeql.Models.Documents;
using snakeql.Models.Tools;
using snakeql.ViewModels.Docks;
using snakeql.ViewModels.Documents;
using snakeql.ViewModels.Tools;
using snakeql.ViewModels.Views;

namespace snakeql.ViewModels;
...
public class DockFactory : Factory
{
    ...
    public override IRootDock CreateLayout()
    {
        ...
        var dashboardView = new DashboardViewModel { Id = "Dashboard", Title = "Dashboard" };
